...
urlpatterns = [
	...
	path('search_all/', search_page, name='searchall'),
    path('upload/', upload_page, name='upload'),
	path('upload_res/',upload_result, name='uploadres'),
	path('online_main/',online_main, name='onlinemain'),
	path('online_main/<subject>',online_main, name='onlinemain'),
	path('payment/',payment,name='payment'),
    path('payment_res/', payment_resView, name='payment_res'),
    path('payment_checkout/', payment_checkoutView, name='payment_checkout'),
	path('coupon_use/' , coupon_use, name = 'coupon_use'),
	path('cart/', cart_detail, name='cart_detail'),
	path('cart_add/<int:product_id>/',add_cart,name = 'add_cart'),
